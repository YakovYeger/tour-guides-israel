  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "h-7 w-7 bg-transparent p-0 hover:opacity-100 inline-flex items-center justify-center rounded-md border border-gray-200 hover:bg-gray-100 z-10",
        button_next: "h-7 w-7 bg-transparent p-0 hover:opacity-100 inline-flex items-center justify-center rounded-md border border-gray-200 hover:bg-gray-100 z-10",
